...
const styles = StyleSheet.create({
  ...
  dayBadgeText: { fontSize: 12, fontWeight: '600', fontFamily: 'Manrope_600SemiBold', color: '#0369a1', textTransform: 'capitalize' },
  ...
  dayChipTextActive: { color: '#0369a1', fontWeight: '600', fontFamily: 'Manrope_600SemiBold',},
  iconBtn: { padding: 6 },
  addBtn: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  moreToggleText: { fontSize: 14, fontWeight: '600', fontFamily: 'Manrope_600SemiBold', color: '#0369a1' },
});
