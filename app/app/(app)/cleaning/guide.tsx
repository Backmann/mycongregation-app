...
const styles = StyleSheet.create({
  ...
  introTitle: { fontSize: 16, fontWeight: '700', color: '#0f172a' },
  ...
  freqText: { fontSize: 12.5, fontWeight: '600', color: '#475569' },
  ...
  directionText: { flex: 1, fontSize: 13.5, color: '#0f172a', fontWeight: '500' },
  listRow: {
    flexDirection: 'row',
