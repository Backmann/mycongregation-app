...
/**
 * Moved to the Congregation tab: /publishers/circuit-overseer (step 3a, 22 September).
 *
...
export default function Moved() {
  ...
  return <Redirect href={{ pathname: '/publishers/circuit-overseer', params } as never} />;
}
