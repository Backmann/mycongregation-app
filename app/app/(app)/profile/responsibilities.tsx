...
/**
 * Moved to the Congregation tab: /publishers/responsibilities (step 3a, 22 September).
 *
...
export default function Moved() {
  ...
  return <Redirect href={{ pathname: '/publishers/responsibilities', params } as never} />;
}
