...
/**
 * Moved to the Congregation tab: /publishers/public-talks-retire (step 3a, 22 September).
 *
...
export default function Moved() {
  ...
  return <Redirect href={{ pathname: '/publishers/public-talks-retire', params } as never} />;
}
