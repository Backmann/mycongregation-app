...
const styles = StyleSheet.create({
  ...
  fieldLabel: { fontSize: 13, color: '#334155', fontWeight: '600', fontFamily: 'Manrope_600SemiBold', marginBottom: 6 },
  input: {
    borderWidth: 1,
    borderColor: '#cbd5e1',
    borderRadius: 8,
  ...
  histDate: { fontSize: 14, color: '#0f172a', fontWeight: '600', fontFamily: 'Manrope_600SemiBold',},
  badge: {
  ...
  badgeText: { fontSize: 10, color: '#166534', fontWeight: '700', fontFamily: 'Manrope_700Bold',},
