...
const styles = StyleSheet.create({
  ...
  navBtn: { padding: 8 },
  weekTitle: { fontSize: 16, fontWeight: '700', fontFamily: 'Manrope_700Bold', color: '#0f172a' },
  ...
  primaryBtnText: { color: '#fff', fontSize: 15, fontWeight: '600', fontFamily: 'Manrope_600SemiBold',},
  ...
  cellTime: { fontSize: 15, fontWeight: '700', fontFamily: 'Manrope_700Bold', color: '#166534' },
  ...
  assignedName: { fontSize: 15, color: '#0f172a', fontWeight: '600', fontFamily: 'Manrope_600SemiBold',},
  applicantRow: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 8,
  ...
  assignBtnText: { color: '#fff', fontSize: 14, fontWeight: '600', fontFamily: 'Manrope_600SemiBold',},
  ...
  linkText: { color: '#0ea5e9', fontSize: 14, fontWeight: '600', fontFamily: 'Manrope_600SemiBold',},
  optChip: {
    paddingHorizontal: 14,
    paddingVertical: 8,
    borderRadius: 8,
  ...
  optChipText: { fontSize: 14, color: '#475569', fontWeight: '600', fontFamily: 'Manrope_600SemiBold',},
  ...
  secondaryBtnText: { color: '#0ea5e9', fontSize: 15, fontWeight: '600', fontFamily: 'Manrope_600SemiBold',},
  windowHeader: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'space-between',
  ...
  windowValue: { fontSize: 14, fontWeight: '700', fontFamily: 'Manrope_700Bold', color: '#0ea5e9' },
  periodLabel: {
    fontSize: 12,
    fontWeight: '600', fontFamily: 'Manrope_600SemiBold',
    color: '#94a3b8',
  ...
  saveBtnText: { color: '#fff', fontSize: 15, fontWeight: '600', fontFamily: 'Manrope_600SemiBold',},
});
