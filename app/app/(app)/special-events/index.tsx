...
const styles = StyleSheet.create({
  ...
  dateDay: { fontSize: 20, fontWeight: '700', fontFamily: 'Manrope_700Bold', color: '#0369a1' },
  dateMon: {
    fontSize: 11,
    color: '#0369a1',
  ...
  rangeNum: { fontSize: 14, fontWeight: '700', fontFamily: 'Manrope_700Bold', color: '#0369a1' },
  typeTag: {
    fontSize: 11,
  ...
  title: { fontSize: 16, fontWeight: '600', fontFamily: 'Manrope_600SemiBold', color: '#0f172a' },
  removedText: { textDecorationLine: 'line-through', color: '#94a3b8' },
  dateRange: { fontSize: 13, color: '#0369a1', fontWeight: '500', fontFamily: 'Manrope_500Medium', marginTop: 2 },
