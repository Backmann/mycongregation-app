...
const styles = StyleSheet.create({
  ...
  langPillText: { fontSize: 13, fontWeight: '600', fontFamily: 'Manrope_600SemiBold', color: '#475569' },
  ...
  docPillText: { fontSize: 13, fontWeight: '500', fontFamily: 'Manrope_500Medium', color: '#334155' },
