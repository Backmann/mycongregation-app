...
export function parseDateRange(
  ...
  /**
   * Crossing into the next year: «28 ДЕКАБРЯ 2026 ГОДА - 3 ЯНВАРЯ 2027 ГОДА».
   *
   * Tried first because the shorter patterns cannot match it at all — a year
   * and the word «года» stand between the month and the dash. It matched
   * nothing, the study article was skipped, and that weekend came out empty
   * every December. Same fix as the server's copy.
   */
